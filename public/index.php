...
<?php
	...
	$points = $db->get('gp g', null, "g.id, g.name as name, g.contact, g.latitude, g.longitude, g.trans_friendly, g.choice_friendly, g.medical_card_friendly, g.ready_to_refer, a.name as area, c.name as county");
